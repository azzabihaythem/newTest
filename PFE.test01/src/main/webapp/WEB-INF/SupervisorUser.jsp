				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <c:forEach var="in" items="${measurementList}">
...
<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<h2>EDITE</h2>
						...
						<form:form method="POST"   action="editSupervisorUser" commandName="UserModel" id="frma" onsubmit="return validation3()" >
   <table>
   <div align="center">
   <tr>
...
<%--         <td><form:errors path="username" ui-state-error class="alert alert-error"/></td> --%>
    ...
    <tr>
        ...
        <td><form:input path="password" id="addpwd" placeHolder="new Password"/></td>
    </tr>
...
function affichage(c){
	...
	$("#edui").attr("action","editSupervisorInformation?id=1");
