		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<font color="red">
					<span>${sessioScoop["SPRING_SECURITY_LAST_EXEPTION"].message}</span>
					</font>
					<form class="form-horizontal"  action='j_spring_security_check' method="POST" >
						...
						<label class="remember" for="remember"><input type="checkbox" name="_spring_security_remember_me" />
						    Remember me</label>
					...
					<p>
						No problem, <a href="passWordRec">click here</a> to get a new password.
					</p>
				</div>
				<!--/span-->
			</div>
